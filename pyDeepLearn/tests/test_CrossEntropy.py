...
class TestCrossEntropy(unittest.TestCase):
    def test_eval1(self):
      logging.info("Running test_eval1")
      ...
      logging.debug("The cross entropy eval returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
      self.assertTrue(output, expected)
      logging.info("test_eval1 ran!")

    def test_eval2(self):
      logging.info("Running test_eval2")
      obj_func = CrossEntropy()
      y = np.array([1, 0, 0])
      ...
      logging.info("test_eval2 ran!")

    def test_eval3(self):
      logging.info("Running test_eval3")
      obj_func = CrossEntropy()
      ...
      self.assertTrue(np_array_comp(output, expected))
      logging.info("test_eval3 ran!")

    def test_gradient1(self):
      logging.info("Running test_gradient1")
      obj_func = CrossEntropy()
      y = np.array([1])
      y_hat = np.array([0.2])
      ...
      logging.info("The cross entropy gradient() returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
      self.assertTrue(np_array_comp(output, expected))
    ...
    def test_gradient2(self):
      logging.info("Running test_gradient2")
      obj_func = CrossEntropy()
      y = np.array([[1, 0, 0]])
      y_hat = np.array([[0.2, 0.2, 0.6]])
      output = obj_func.gradient(y, y_hat)
      ...
      logging.debug("The cross entropy gradient() returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
      self.assertTrue(np_array_comp(output, expected))
