...
class TestLinearLayer(unittest.TestCase):
    ...
    def test_forward(self):
      logging.info("start test_forward ran!")
    ...
    def test_gradient(self):
      logging.info("start test_gradient ran!")
    ...
    def test_hw1(self):
      ...
      logging.debug("The linear layer returned \n" +
    ...
    def test_hw2(self):
      ...
      logging.debug("The Linear Layer grad returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
