...
class TestSigmoidLayer(unittest.TestCase):
    ...
    def test_gradient(self):
      logging.info("test_gradient start!")
    ...
    def test_gradient2(self):
      logging.info("test_gradient start2!")
    ...
    def test_hw1(self):
      ...
      logging.debug("The sigmoid layer returned \n" +
    ...
    def test_hw2(self):
      ...
      logging.debug("The Sigmoid Layer grad returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
