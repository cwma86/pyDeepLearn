...
class TestFullyConnectedLayer(unittest.TestCase):
    ...
    def test_constructor1(self):
      ...
      logging.info("test_constructor1 ran!")

    def test_forward1(self):
      logging.info("test_forward1 runngin!")
      ...
      logging.info("test_forward1 ran!")

    def test_forward2(self):
      logging.info("test_forward2 runngin!")
      np.random.seed(0)
      ...
      self.assertTrue(np_array_comp(obs, obs_truth))
      logging.info("test_forward2 ran!")

    def test_forward3(self):
      logging.info("test_forward3 runngin!")
      np.random.seed(0)
      ...
      self.assertTrue(np_array_comp(obs, obs_truth))
      logging.info("test_forward3 ran!")

    def test_forward4(self):
      logging.info("test_forward4 runngin!")
      np.random.seed(0)
      input_data = np.array([[1.0, 2.0, 3.0],
                            [3.0, 4.0, 5.0]])
      sizeOut = 2  # as defined in HW 1
      ...
      self.assertTrue(np_array_comp(obs, obs_truth))
      logging.info("test_forward4 ran!")

    def test_hw1(self):
      print()
      logging.info("Starting: test_hw1")
      # Seed the random number generator for consistent results
      np.random.seed(0)
      ...
      logging.debug("The fully connected layer returned \n" +
      ...
      logging.info("Complete: test_hw1")
    ...
    def test_gradient1(self):
      ...
      logging.info("test_gradient1 ran!")

    def test_gradient2(self):
      logging.info("test_gradient2 running!")
      np.random.seed(0)
      input_data = np.array([[1.0, 2.0, 3.0],
                            [3.0, 4.0, 5.0]])
      sizeOut = 2  # as defined in HW 1
      ...
      self.assertTrue(np_array_comp(obs, obs_truth))
      # TODO not implemented
      logging.info("test_gradient2 ran!")

    def test_updateweights(self):
      logging.info("test_updateweights running!")
      np.random.seed(0)
      input_data = np.array([[1.0, 2.0, 3.0]])
      sizeOut = 2  # as defined in HW 1
      input_layer = FullyConnectedLayer(len(input_data[0]), sizeOut)
      ...
      # TODO not implemented
      logging.info("test_updateweights ran!")

    def test_hw2(self):
      print()
      logging.info("Starting: test_hw2")
      # Seed the random number generator for consistent results
      np.random.seed(0)
      ...
      logging.debug("The fully connected layer grad returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
      ...
      self.assertTrue(np_array_comp(output, expected_out))
      logging.info("Complete: test_hw2")
