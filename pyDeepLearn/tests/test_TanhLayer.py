...
class TestTanhLayer(unittest.TestCase):
    ...
    def test_gradient(self):
      logging.info("start test_gradient2 ")
    ...
    def test_hw1(self):
      ...
      logging.debug("The Tanh layer returned \n" +
    ...
    def test_hw2(self):
      ...
      print(f"grad {output}")
      logging.debug("The Tanh layer grad returned \n" +
                   f"{np.array2string(output, separator=', ')}"
                  )
      expected_out = np.array(
